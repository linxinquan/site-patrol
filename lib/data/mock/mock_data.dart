...
const Map<String, Drawing> drawings = {
  'nkf_total': Drawing(
    key: 'nkf_total',
    title: '建施报_01_V1.0_总平面图',
    crumb: '总平面图',
    variant: 'plan',
    src: 'assets/drawings/nkf_total.png',
    w: 1500,
    h: 944,
    hotspots: [
      Hotspot(
  ...
  'nkf_total_v': Drawing(
      key: 'nkf_total_v',
      title: '建施报_02_V1.0_首层竖向总平面图',
      crumb: '竖向总平面',
      variant: 'plan',
      src: 'assets/drawings/nkf_total_v.png',
      w: 1500,
      h: 944,
      hotspots: []),
  'nkf_west_b2': Drawing(
      key: 'nkf_west_b2',
      title: '建施报_04_V1.0_西楼地下二层平面图',
      crumb: '西楼 B2',
      variant: 'plan',
      src: 'assets/drawings/nkf_west_b2.png',
      w: 1500,
      h: 944,
      hotspots: []),
  'nkf_west_b1': Drawing(
      key: 'nkf_west_b1',
      title: '建施报_05_V1.0_西楼地下一层平面图',
      crumb: '西楼 B1',
      variant: 'plan',
      src: 'assets/drawings/nkf_west_b1.png',
      w: 1500,
      h: 944,
      hotspots: []),
  'nkf_west_1f': Drawing(
    key: 'nkf_west_1f',
    title: '建施报_06_V1.0_西楼一层平面图',
    crumb: '西楼 1F',
    variant: 'plan',
    src: 'assets/drawings/nkf_west_1f.png',
    w: 1500,
    h: 944,
    hotspots: [
      Hotspot(
          num: 3, label: '左病房翼 → 2F', target: 'nkf_west_2f', x: 0.18, y: 0.38),
      Hotspot(
          num: 4,
          label: '门诊大厅/医疗街 → 2F',
          target: 'nkf_west_2f',
          ...
          y: 0.32),
      Hotspot(
          num: 5, label: '右病房翼 → 4F', target: 'nkf_west_4f', x: 0.82, y: 0.38),
      Hotspot(
          num: 6,
          label: '中央医街/电梯厅 → 2F',
          target: 'nkf_west_2f',
  ...
  'nkf_west_2f': Drawing(
      key: 'nkf_west_2f',
      title: '建施报_07_V1.0_西楼二层平面图',
      crumb: '西楼 2F',
      variant: 'plan',
      src: 'assets/drawings/nkf_west_2f.png',
      w: 1500,
      h: 944,
      hotspots: []),
  'nkf_west_4f': Drawing(
      key: 'nkf_west_4f',
      title: '建施报_09_V1.0_西楼四层平面图',
      crumb: '西楼 4F',
      variant: 'plan',
      src: 'assets/drawings/nkf_west_4f.png',
      w: 1500,
      h: 944,
      hotspots: []),
  'nkf_east_1f': Drawing(
    key: 'nkf_east_1f',
    title: '建施报_20_V1.0_东楼一层平面图',
    crumb: '东楼 1F',
    variant: 'plan',
    src: 'assets/drawings/nkf_east_1f.png',
    w: 1500,
    h: 1062,
    hotspots: [
      Hotspot(
  ...
  'nkf_east_4f': Drawing(
      key: 'nkf_east_4f',
      title: '建施报_23_V1.0_东楼四层平面图',
      crumb: '东楼 4F',
      variant: 'plan',
      src: 'assets/drawings/nkf_east_4f.png',
      w: 1500,
      h: 1062,
      hotspots: []),
  'nkf_inf_1f': Drawing(
      key: 'nkf_inf_1f',
      title: '建施报_31_V1.0_感染楼一层平面图',
      crumb: '感染楼 1F',
      variant: 'plan',
      src: 'assets/drawings/nkf_inf_1f.png',
      w: 1500,
      h: 1062,
      hotspots: []),
  'nkf_cor_1f': Drawing(
      key: 'nkf_cor_1f',
      title: '建施报_38_V1.0_连廊一层平面图',
      crumb: '连廊 1F',
      variant: 'plan',
      src: 'assets/drawings/nkf_cor_1f.png',
      w: 1500,
      h: 1062,
      hotspots: []),
};
...
const Map<String, List<PhotoAnchor>> photoAnchors = {
  '西楼1F': [
    PhotoAnchor(
        ...
        photos: [
          AnchorPhoto(
              file: 'photo_nuclear_rebar.jpg',
              date: '2026-06-10',
              caption: '核医学科房翼钢筋绑扎间距均匀'),
        ]),
    PhotoAnchor(
        id: 'w1-corridor',
        x: 0.249,
        ...
        photos: [
          AnchorPhoto(
              file: 'photo_corridor_beam.jpg',
              date: '2026-06-20',
              caption: '架空通廊下挂梁柱一次成型'),
        ]),
    PhotoAnchor(
        id: 'w1-street',
        x: 0.451,
        ...
        photos: [
          AnchorPhoto(
              file: 'photo_street_structure.jpg',
              date: '2026-07-02',
              caption: '中央医街二次结构加固规范'),
        ]),
    PhotoAnchor(
        id: 'w1-hall',
        x: 0.437,
        ...
        photos: [
          AnchorPhoto(
              file: 'photo_hall_formwork.jpg',
              date: '2026-06-15',
              caption: '模板安装、弹线画点'),
          AnchorPhoto(
              file: 'photo_hall_arc_form.jpg',
              date: '2026-06-22',
              caption: '门诊大厅定制弧形模板'),
          AnchorPhoto(
              file: 'photo_hall_arc_done.jpg',
              date: '2026-07-05',
              caption: '弧形结构成型效果'),
        ]),
    PhotoAnchor(
        ...
        photos: [
          AnchorPhoto(
              file: 'photo_gyn_masonry.jpg',
              date: '2026-06-28',
              caption: '妇科门诊房翼砌体施工灰缝顺直饱满'),
        ]),
  ],
  '东楼1F': [
    PhotoAnchor(id: 'e1-out', x: 0.50, y: 0.35, label: '门诊大厅', photos: [
      AnchorPhoto(
          file: 'photo_e1_column.jpg',
          date: '2026-06-12',
          caption: '东楼门诊大厅墙柱梯柱筋防偏位'),
    ]),
    PhotoAnchor(id: 'e1-ward', x: 0.25, y: 0.55, label: '住院部', photos: [
      AnchorPhoto(
          file: 'photo_e1_top.jpg', date: '2026-07-20', caption: '东楼住院部封顶航拍记录'),
    ]),
  ],
  '总平面图': [
    PhotoAnchor(id: 'site-aero', x: 0.50, y: 0.50, label: '项目全景', photos: [
      AnchorPhoto(
          file: 'photo_site_aero.jpg',
          date: '2026-05-30',
          caption: '未封顶航拍：可利用的场所合理布置'),
      AnchorPhoto(
          file: 'photo_e1_top.jpg', date: '2026-07-20', caption: '项目封顶航拍图'),
    ]),
    PhotoAnchor(id: 'site-energy', x: 0.38, y: 0.58, label: '光储直柔', photos: [
      AnchorPhoto(
          file: 'photo_site_energy.png',
          date: '2026-07-10',
          caption: '项目“光储直柔”应用实施图'),
    ]),
  ],
};
...
const List<Defect> defects = [
  Defect(
      ...
      floor: '西楼1F',
      ts: '2026-08-08 14:32',
      gps: '22.5936°N 113.9798°E',
      alt: '海拔 18.2m',
      resp: '深圳市建工集团 王工',
      respUnit: '深圳市建工集团',
      reporter: '现场监理 陈工',
      tags: ['精装修', '注浆处理'],
      note: '空鼓面积约 0.4㎡，需注浆处理',
      seed: 'a',
      building: '西楼',
      completion: '未开始',
      closeNote: '待总包排期整改，计划下周进场',
      suggestion:
  ...
  Defect(
      ...
      seed: 'b',
      building: '东楼',
      importance: DefectImportance.importantNotUrgent,
      reply: '已完成注浆封堵，48h 闭水试验无渗漏，附整改后照片。',
      replyBy: '深圳市建工集团 李工',
      replyTs: '2026-08-10 16:20',
      completion: '已完成'),
  Defect(
      id: 'd3',
      projectId: 'nkf',
      ...
      seed: 'c',
      building: '感染楼',
      reply: '实测偏差 8mm，在规范允许范围（≤10mm）内，申请予以销项。',
      replyBy: '中海监理 张工',
      replyTs: '2026-08-09 10:05',
      completion: '已完成',
  ...
  Defect(
      ...
      reply: '已完成裂缝注浆与碳纤维布加固，待第三方检测复检。',
      replyBy: '深圳市建工集团 王工',
      replyTs: '2026-08-12 09:30',
      completion: '进行中',
      closeNote: '待第三方检测报告出具后闭合',
      suggestion:
  ...
  Defect(
      ...
      seed: 'f',
      building: '东楼',
      reply: '空鼓地砖已全部更换并重铺，复检合格。',
      replyBy: '深圳市建安集团 周工',
      replyTs: '2026-08-07 17:40',
      completion: '已完成'),
];
...
const Map<String, List<TimelinePhoto>> timeline = {
  '西楼1F-左病房翼': [
    TimelinePhoto(
      date: '2026-07-12',
      state: 'before',
      caption: '墙面空鼓初现，敲击有空响',
      verified: true,
      imagePath: 'assets/photos/photo_hall_formwork.jpg',
      isAsset: true,
    ),
    TimelinePhoto(
      date: '2026-07-28',
      ...
      caption: '注浆施工中',
      verified: true,
      imagePath: 'assets/photos/photo_hall_arc_form.jpg',
      isAsset: true,
    ),
    TimelinePhoto(
      date: '2026-08-08',
      ...
      caption: '注浆后复查无空鼓',
      verified: true,
      imagePath: 'assets/photos/photo_hall_arc_done.jpg',
      isAsset: true,
    ),
  ],
};
...
const List<VlDefect> realSteelDefects = [
  ...
  VlDefect(
    ...
    conf: 1.0,
    desc:
        '一根钢筋斜搭于柱钢筋笼上，仅中部一处用扎丝简单绑扎，两端均未与柱笼或板面钢筋网有效锚固固定，不能起到定尺撑稳固作用，属散置乱摆钢筋，应清除或按防倾倒措施要求重新固定。',
  ...
  if (kw.contains('裂缝') || kw.contains('顶棚')) {
    return const [
      ...
      VlDefect(
          ...
          severity: DefectSeverity.green,
          conf: 0.81,
          suggestion: '1）沿缝剔凿 V 形槽并清理浮灰；2）聚合物修补砂浆填实压光；3）养护后复查是否重新开裂。'),
    ];
  }
  return const [
    VlDefect(
...
const List<Floor> dy7Floors = [
  Floor(
      key: 'dy04_7_B05',
      name: '建筑 AW-7-B05 V1.0 地下室夹层组合平面图',
      index: 0,
      cached: true,
      progress: 100,
      building: '7栋',
  ...
  Floor(
      key: 'dy04_7_B01',
      name: '建筑 AW-7-B01 V1.0 地下一层顶板组合平面图',
      index: 1,
      cached: true,
      progress: 100,
      building: '7栋',
  ...
  Floor(
      key: 'dy04_7_D01',
      name: '建筑 AW-7-D01 V1.0 A座1-1剖面图',
      index: 2,
      cached: true,
      progress: 100,
      building: '7栋',
  ...
  Floor(
      key: 'dy04_7_D03',
      name: '建筑 AW-7-D03 V1.0 B座1-1剖面图',
      index: 3,
      cached: true,
      progress: 100,
      building: '7栋',
  ...
  Floor(
      key: 'dy04_7_D04',
      name: '建筑 AW-7-D04 V1.0 B座2-2剖面图',
      index: 4,
      cached: true,
      progress: 100,
      building: '7栋',
  ...
  Floor(
      key: 'dy04_7_E01',
      name: '建筑 AW-7-E01 V1.0 A座7A-LT01楼梯详图（一）',
      index: 7,
      cached: true,
      progress: 100,
      building: '7栋',
  ...
  Floor(
      key: 'dy04_7_F01',
      name: '建筑 AW-7-F01 V1.0 B座7B-LT01楼梯详图（一）',
      index: 8,
      cached: true,
      progress: 100,
      building: '7栋',
  ...
  Floor(
      key: 'dy04_7_J01',
      name: '建筑 AW-7-J01 V1.0 A座门窗详图（一）',
      index: 9,
      cached: true,
      progress: 100,
      building: '7栋',
  ...
  Floor(
      key: 'dy04_7_J04',
      name: '建筑 AW-7-J04 V1.0 B座门窗详图（一）',
      index: 10,
      cached: true,
      progress: 100,
      building: '7栋',
...
const Map<String, Drawing> dy7Drawings = {
  'dy04_7_B05': Drawing(
      key: 'dy04_7_B05',
      title: '建筑 AW-7-B05 V1.0 地下室夹层组合平面图',
      crumb: '7栋 B1',
      variant: 'plan',
      // ★ B05 截图底图（PDF 布局空间，4500×2551，对应物理页 1489×844mm），
      // 配合 cad_calib 校准系数实现真实图纸坐标定位（已验证 <2mm）。
      src: 'assets/drawings/dy04_7_B05_paper_hybrid.png',
      w: 4500,
      h: 2551,
      hotspots: [],
  ...
  'dy04_7_B01': Drawing(
      key: 'dy04_7_B01',
      title: '建筑 AW-7-B01 V1.0 地下一层顶板组合平面图',
      crumb: '7栋 B1',
      variant: 'plan',
      src: 'assets/drawings/dy04_7_B01.png',
      w: 4500,
      h: 3186,
      hotspots: [],
      cadOcfKey: 'dy04_7_B01'),
  'dy04_7_D01': Drawing(
      key: 'dy04_7_D01',
      title: '建筑 AW-7-D01 V1.0 A座1-1剖面图',
      crumb: '7栋 剖面',
      variant: 'section',
      src: 'assets/drawings/dy04_7_D01.png',
      w: 2400,
      h: 1133,
      hotspots: [],
      cadOcfKey: 'dy04_7_D01'),
  'dy04_7_D03': Drawing(
      key: 'dy04_7_D03',
      title: '建筑 AW-7-D03 V1.0 B座1-1剖面图',
      crumb: '7栋 剖面',
      variant: 'section',
      src: 'assets/drawings/dy04_7_D03.png',
      w: 2400,
      h: 1698,
      hotspots: [],
      cadOcfKey: 'dy04_7_D03'),
  'dy04_7_D04': Drawing(
      key: 'dy04_7_D04',
      title: '建筑 AW-7-D04 V1.0 B座2-2剖面图',
      crumb: '7栋 剖面',
      variant: 'section',
      src: 'assets/drawings/dy04_7_D04.png',
      w: 2400,
      h: 1698,
      hotspots: [],
      cadOcfKey: 'dy04_7_D04'),
  'dy04_7_K01': Drawing(
      key: 'dy04_7_K01',
      title: '建筑 AW-7-K01 V1.0 墙身详图（一）',
      crumb: '7栋 详图',
      variant: 'detail',
      src: 'assets/drawings/dy04_7_K01.png',
      w: 2400,
      h: 3398,
      hotspots: [],
      cadOcfKey: 'dy04_7_K01'),
  'dy04_7_K02': Drawing(
      key: 'dy04_7_K02',
      title: '建筑 AW-7-K02 V1.0 墙身详图（二）',
      crumb: '7栋 详图',
      variant: 'detail',
      src: 'assets/drawings/dy04_7_K02.png',
      w: 2400,
      h: 3398,
      hotspots: [],
      cadOcfKey: 'dy04_7_K02'),
  'dy04_7_E01': Drawing(
      key: 'dy04_7_E01',
      title: '建筑 AW-7-E01 V1.0 A座7A-LT01楼梯详图（一）',
      crumb: '7栋 详图',
      variant: 'detail',
      src: 'assets/drawings/dy04_7_E01.png',
      w: 2401,
      h: 1696,
      hotspots: [],
      cadOcfKey: 'dy04_7_E01'),
  'dy04_7_F01': Drawing(
      key: 'dy04_7_F01',
      title: '建筑 AW-7-F01 V1.0 B座7B-LT01楼梯详图（一）',
      crumb: '7栋 详图',
      variant: 'detail',
      src: 'assets/drawings/dy04_7_F01.png',
      w: 2400,
      h: 5087,
      hotspots: [],
      cadOcfKey: 'dy04_7_F01'),
  'dy04_7_J01': Drawing(
      key: 'dy04_7_J01',
      title: '建筑 AW-7-J01 V1.0 A座门窗详图（一）',
      crumb: '7栋 详图',
      variant: 'detail',
      src: 'assets/drawings/dy04_7_J01.png',
      w: 2401,
      h: 1696,
      hotspots: [],
      cadOcfKey: 'dy04_7_J01'),
  'dy04_7_J04': Drawing(
      key: 'dy04_7_J04',
      title: '建筑 AW-7-J04 V1.0 B座门窗详图（一）',
      crumb: '7栋 详图',
      variant: 'detail',
      src: 'assets/drawings/dy04_7_J04.png',
      w: 2400,
      h: 1698,
      hotspots: [],
      cadOcfKey: 'dy04_7_J04'),
};
