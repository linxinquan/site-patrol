...
- 当前目标：完善「拍照量尺校对」功能（设计师用：照片标定测距 vs 图纸尺寸对比判定）
...
2. 每完成一项：`flutter analyze` 无新增 error
3. 完成后对照 `TEST_PLAN_MEASURE.md` 第 0~4 节自查一遍（尤其 1.1 竖线标定、2.x 标记对齐、4.x 全流程）
